...
// Utility function to get smoothed Y position
...
export const JumpDetection = ({ onJump }: JumpDetectionProps) => {
  // Refs
  ...
  // Start everything - camera and model loading
  ...
  return (
    <div className="mx-auto max-w-lg p-4">
      <div className="relative mb-2 w-full">
        <video
          ref={videoRef}
          className="mx-auto w-full max-w-2xl rounded-lg border border-gray-300"
          playsInline
        />
        <canvas
          ref={canvasRef}
