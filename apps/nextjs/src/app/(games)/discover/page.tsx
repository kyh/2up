  ...
  return (
    <>
      ...
      <main className="flex min-h-dvh flex-col">
        ...
        <footer className="text-muted-foreground relative mt-auto flex flex-col gap-2 overflow-hidden pt-20 pb-10 text-center text-sm font-medium tracking-[-0.2px]">
          <div>
            made with{" "}
