...
export const StarBackground = memo(
  ...
  (prevProps, nextProps) => {
    return (
      prevProps.starDensity === nextProps.starDensity &&
      prevProps.allStarsTwinkle === nextProps.allStarsTwinkle &&
      prevProps.twinkleProbability === nextProps.twinkleProbability &&
      prevProps.minTwinkleSpeed === nextProps.minTwinkleSpeed &&
      prevProps.maxTwinkleSpeed === nextProps.maxTwinkleSpeed &&
