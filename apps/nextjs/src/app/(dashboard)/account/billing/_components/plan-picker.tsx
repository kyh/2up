...
import {
  ...
  getPrimaryLineItem,
  getProductPlanPair,
} from "@2up/api/billing/billing-util";
...
import {
  ...
  RadioGroupItem,
  RadioGroupItemLabel,
} from "@2up/ui/radio-group";
import { Separator } from "@2up/ui/separator";
...
import type {
  BillingConfig,
  LineItemSchema,
} from "@2up/api/billing/billing-schema";
...
const PlanDetails = ({
  ...
  return (
    <div
      key={key}
      className="animate-in fade-in zoom-in-95 flex w-full flex-col space-y-4 py-2 lg:px-8"
    >
...
const Price = (props: React.PropsWithChildren) => (
  <span className="animate-in fade-in slide-in-from-left-4 text-xl font-bold duration-500">
    {props.children}
  </span>
);
