...
import { Button } from "./components/ui/NosButton";
import { Container } from "./components/ui/NosContainer";
import { IconButton } from "./components/ui/NosIconButton";
import { Input } from "./components/ui/NosInput";
  ...
  return (
    <div className="flex h-full w-full flex-col gap-6">
      ...
      <div className="flex items-center gap-6">
        <div className="flex h-[392px] w-full max-w-[800px] flex-col gap-8 rounded-2xl bg-primary p-10">
          <div className="flex flex-col gap-3">
            <h2 className="text-3xl font-medium text-normal">
        ...
        <div className="flex flex-col gap-6">
          <div className="flex h-[184px] w-full max-w-[395px] items-center justify-start gap-4 rounded-2xl bg-normal p-6">
            <KeyIcon />
      ...
      <Container variant="normal" rounded>
        <div className="flex w-full items-center justify-between">
          <h2 className="text-3xl font-medium text-dark">Featured</h2>
        ...
        <div className="flex items-center gap-6">
          <div className="flex w-full max-w-[276px] flex-col gap-4 rounded-2xl">
            ...
            <div className="flex flex-col gap-1">
              <p className="text-2xl font-medium text-dark">Geography pack</p>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center gap-6">
              <div className="flex w-full max-w-[184px] flex-col items-center justify-center gap-2 rounded-2xl bg-white px-5 py-10">
                ...
                <p className="text-lg text-dark">Puzzles</p>
              </div>
      ...
      <Container variant="normal" rounded>
        <div className="flex w-full items-center justify-between">
          <h2 className="text-3xl font-medium text-dark">Hot and new</h2>

          <Button variant="link">
            <span className="uppercase text-yellow-600 underline ">
              See All
            </span>
          </Button>
        </div>
      ...
      <Container variant="transparent">
        <div className="flex w-full flex-col gap-6">
          <h2 className="text-4xl font-medium text-dark">Browse all games</h2>
        ...
        <div className="flex w-full flex-col gap-10">
          <div className="flex items-center gap-6">
            <div className="flex h-[256px] flex-col gap-3 rounded-2xl bg-white p-4">
              ...
              <div className="flex flex-col gap-1">
                <p className="text-2xl font-medium text-dark">Game title</p>
                <p className="text-sm text-dark">Game description short</p>
              </div>
            </div>
